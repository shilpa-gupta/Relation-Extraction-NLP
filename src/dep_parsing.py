...
def load_dep_feat():
    all_feats = []
    with open("../data/dep_feat_combined.csv", 'r', encoding="utf-8") as input:
        for line in input:
            tokens = line.split(",")
...
if __name__ == "__main__":
    ...
    generate_arff_file(feature_vectors[:6000], all_tokens, "../data/dep_feat_only_arff/train.arff")
    generate_arff_file(feature_vectors[6000:], all_tokens, "../data/dep_feat_only_arff/test.arff")
